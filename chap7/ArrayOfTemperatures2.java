//listing 7.2
/**
Reads temperatures from the user and shows which are above and which are below the average of all the temperatures. */
...
public class ArrayOfTemperatures2 {
    public static void main(String[] args) {
        ...
        // Read temperatures and compute their average: System.out.println("Enter " + temperature.length + " temperatures:");
        double sum = 0; 
